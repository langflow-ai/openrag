...
type FakeBomalogicV1alpha1 struct {
	*testing.Fake
}

func (c *FakeBomalogicV1alpha1) BomaRAGs(namespace string) v1alpha1.BomaRAGInterface {
	return newFakeBomaRAGs(c, namespace)
}

// RESTClient returns a RESTClient that is used to communicate
// with API server by this client implementation.
func (c *FakeBomalogicV1alpha1) RESTClient() rest.Interface {
