...
| `DASHBOARD_PORT` | `5601` | Host port for the OpenSearch Dashboards service. Change this if port 5601 is already in use on your system (e.g., by Kibana or another OpenSearch Dashboards instance). |
