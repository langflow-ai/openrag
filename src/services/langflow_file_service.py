...
class LangflowFileService:
    ...
    async def run_ingestion_flow(
        ...
        headers = {
            ...
            "X-Langflow-Global-Var-SELECTED_EMBEDDING_MODEL_PROVIDER": str(config.knowledge.embedding_provider or ""),
            "X-Langflow-Global-Var-SELECTED_LANGUAGE_MODEL": str(config.agent.llm_model or ""),
            "X-Langflow-Global-Var-SELECTED_LANGUAGE_MODEL_PROVIDER": str(config.agent.llm_provider or ""),
