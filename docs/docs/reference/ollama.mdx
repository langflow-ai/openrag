...
To run this model in Ollama Cloud, follow the steps in [Connect to Ollama Cloud models](#ollama-cloud).
To run this model on a remote desktop server, follow the steps in [Connect to a remote Ollama instance](#ollama-remote).
...
To connect to a remote machine running Ollama, do the following:
