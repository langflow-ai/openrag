    ...
    ConfigSection(
        ...
        [
            ...
            ConfigField(
                ...
                placeholder="bomarag",
                default="bomarag",
                helper_text="Identifier for AAD tenant binding (default: bomarag)",
            ),
            ConfigField(
                "bomarag_enforce_prerequisites",
                "BOMARAG_ENFORCE_PREREQUISITES",
    ...
    ConfigSection(
        ...
        [
            ...
            ConfigField(
                ...
                "LANGFLOW_DATA_PATH",
                "Data Path",
                placeholder="~/.bomarag/data/langflow-data",
                default="$HOME/.bomarag/data/langflow-data",
    ...
    ConfigSection(
        ...
        [
            ConfigField(
                ...
                "BOMARAG_DOCUMENTS_PATHS",
                "Documents Paths",
                placeholder="~/.bomarag/documents",
                default="$HOME/.bomarag/documents",
