  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=default]/tabs-list:hover:bg-foreground group-data-[variant=default]/tabs-list:hover:text-background group-data-[variant=default]/tabs-list:focus:bg-foreground group-data-[variant=default]/tabs-list:focus:text-background group-data-[variant=default]/tabs-list:focus-visible:bg-foreground group-data-[variant=default]/tabs-list:focus-visible:text-background group-data-[variant=default]/tabs-list:focus-visible:ring-0 group-data-[variant=default]/tabs-list:focus-visible:ring-offset-0 group-data-[variant=default]/tabs-list:data-[state=active]:bg-foreground group-data-[variant=default]/tabs-list:data-[state=active]:text-background",
