...
4. **Advanced Setup** only: To enable OAuth mode or cloud storage connectors, enter the relevant OAuth credentials under **API Keys**, and then register the redirect URIs shown in the TUI in your OAuth apps.
   ...
   The redirect URIs are used for the cloud storage connector webhooks.
   For Google, the redirect URIs are also used to redirect users back to OpenRAG after they sign in.
...
6. Optional: Under **Others**, you can edit the following settings if needed:
   ...
   * **Documents Paths**: Use the default path, or provide a path to a directory where you want OpenRAG to look for documents to ingest into your [knowledge base](/knowledge).
