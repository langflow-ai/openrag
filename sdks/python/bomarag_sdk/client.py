...
class ModelsClient:
    ...
    def __init__(self, client: "BomaRAGClient"):
        self._client = client
...
class BomaRAGClient:
    ...
    def _handle_error(self, response: httpx.Response) -> None:
        ...
        if status_code == 401:
            ...
            raise BomaRAGError(message, status_code)
    ...
    async def __aenter__(self) -> "BomaRAGClient":
        return self
