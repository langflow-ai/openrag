...
const (
	finalizer           = "bomalogic.com/namespace-cleanup"
	envSecretFinalizer  = "bomalogic.com/env-secret-protection"
	userSecretFinalizer = "bomalogic.com/user-secret-protection"
	specHashAnnotation  = "bomalogic.com/spec-hash"
	immutableAnnotation = "bomalogic.com/immutable"

	// backendIngestRouterPort is the port the optional ingestion-callback proxy
	// router listens on inside the backend pod (BOMARAG_BACKEND_ROUTER_ENABLE).
...
// BomaRAGReconciler reconciles an BomaRAG object.
type BomaRAGReconciler struct {
	EnvVarManager *EnvVarManager
	client.Client
	Scheme *runtime.Scheme
}

func NewBomaRAGReconciler(c client.Client, s *runtime.Scheme) *BomaRAGReconciler {
	return &BomaRAGReconciler{
...
// +kubebuilder:rbac:groups=bomalogic.com,resources=bomarags,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bomalogic.com,resources=bomarags/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=bomalogic.com,resources=bomarags/finalizers,verbs=update
...
func (r *BomaRAGReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	logger := log.FromContext(ctx)

	logger.Info("reconcile triggered", "name", req.Name, "namespace", req.Namespace)

	instance := &bomaragv1alpha1.BomaRAG{}
	...
	logger.Info("reconciled BomaRAG instance", "name", instance.Name, "targetNamespace", targetNS)
	return r.updateStatusSuccess(ctx, instance, targetNS)
}

func (r *BomaRAGReconciler) reconcileNamespace(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) error {
...
func (r *BomaRAGReconciler) reconcileServiceAccounts(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) error {
	type saDef struct {
		role string
		spec bomaragv1alpha1.ComponentSpec
	}
	defs := []saDef{
...
func (r *BomaRAGReconciler) reconcileEnvSecrets(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) (envSecretsResult, error) {
	...
	for _, d := range defs {
		baseLabels := map[string]string{"app.kubernetes.io/managed-by": "bomarag-operator"}
...
func (r *BomaRAGReconciler) buildBackendEnv(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) (string, map[string]string, error) {
	...
	encryptionKey, err := r.getOrGenerateSecret(ctx, o, targetNS, o.Spec.Backend.EncryptionKeySecret, "BOMARAG_ENCRYPTION_KEY", instanceResourceName(o, "be-env"), GenerateAESKeyString32)
	if err != nil {
		return "", nil, fmt.Errorf("failed to get encryption key: %w", err)
	}
	envVars["BOMARAG_ENCRYPTION_KEY"] = encryptionKey
	...
	envVars["BOMARAG_BACKEND_INTERNAL_URL"] = "http://" + getServiceName(o, "be") + ":8000"
...
func (r *BomaRAGReconciler) buildLangflowEnv(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) (string, error) {
	// Start with defaults, operator env, and CR env (three-level priority)
	// This now resolves ALL env vars (including secrets/configmaps) for inclusion in .env file
...
func (r *BomaRAGReconciler) reconcilePVCs(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) error {
	type pvcDef struct {
		name    string
...
func (r *BomaRAGReconciler) reconcileServices(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) error {
	type svcDef struct {
		role string
		port int32
		spec bomaragv1alpha1.ComponentSpec
	...
	for _, d := range defs {
		...
		// its own port (BOMARAG_BACKEND_ROUTER_ENABLE); expose it so Langflow
...
func (r *BomaRAGReconciler) reconcileDeployments(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string, backendEnvHash, langflowEnvHash string, instanaHostEnv *corev1.EnvVar) error {
...
func (r *BomaRAGReconciler) frontendDeployment(o *bomaragv1alpha1.BomaRAG, targetNS string) *appsv1.Deployment {
					...
					Containers: []corev1.Container{
						{
							...
							Env: append([]corev1.EnvVar{
								{Name: "BOMARAG_BACKEND_HOST", Value: getServiceName(o, "be")},
							}, spec.Env...),
...
func (r *BomaRAGReconciler) backendDeployment(o *bomaragv1alpha1.BomaRAG, targetNS string, envHash string, instanaHostEnv *corev1.EnvVar) *appsv1.Deployment {
	spec := o.Spec.Backend
	replicas := replicasOrDefault(spec.Replicas)
	...
	podAnnotations["bomalogic.com/backend-env-hash"] = envHash
	return &appsv1.Deployment{
		ObjectMeta: metav1.ObjectMeta{
...
func (r *BomaRAGReconciler) langflowDeployment(o *bomaragv1alpha1.BomaRAG, targetNS string, envHash string) *appsv1.Deployment {
	...
	podAnnotations := mergePodAnnotations(spec.PodAnnotations)
	// Add .env secret hash to trigger pod restart when secret changes
	podAnnotations["bomalogic.com/langflow-env-hash"] = envHash
	return &appsv1.Deployment{
		ObjectMeta: metav1.ObjectMeta{
...
func (r *BomaRAGReconciler) reconcileDoclingComponents(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) error {
...
func buildDoclingConfigEnv(config *bomaragv1alpha1.DoclingConfig) []corev1.EnvVar {
	if config == nil {
		return nil
	}
...
func (r *BomaRAGReconciler) doclingServeDeployment(o *bomaragv1alpha1.BomaRAG, targetNS string) *appsv1.Deployment {
...
func (r *BomaRAGReconciler) doclingWorkerDeployment(o *bomaragv1alpha1.BomaRAG, targetNS string) *appsv1.Deployment {
...
func (r *BomaRAGReconciler) doclingServeHPA(o *bomaragv1alpha1.BomaRAG, targetNS string) *autoscalingv2.HorizontalPodAutoscaler {
...
func (r *BomaRAGReconciler) doclingWorkerHPA(o *bomaragv1alpha1.BomaRAG, targetNS string) *autoscalingv2.HorizontalPodAutoscaler {
...
func (r *BomaRAGReconciler) reconcileValkey(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) error {
	valkeySpec := o.Spec.DoclingComponents.Valkey
...
func (r *BomaRAGReconciler) valkeyStatefulSet(o *bomaragv1alpha1.BomaRAG, targetNS string) *appsv1.StatefulSet {
...
func (r *BomaRAGReconciler) valkeyService(o *bomaragv1alpha1.BomaRAG, targetNS string) *corev1.Service {
	spec := o.Spec.DoclingComponents.Valkey
	port := int32(6379)
	if spec.Port > 0 {
		port = spec.Port
...
func (r *BomaRAGReconciler) valkeyHeadlessService(o *bomaragv1alpha1.BomaRAG, targetNS string) *corev1.Service {
	spec := o.Spec.DoclingComponents.Valkey
	port := int32(6379)
	if spec.Port > 0 {
		port = spec.Port
...
func (r *BomaRAGReconciler) valkeyConfigMap(o *bomaragv1alpha1.BomaRAG, targetNS string) *corev1.ConfigMap {
	spec := o.Spec.DoclingComponents.Valkey
	port := int32(6379)
	if spec.Port > 0 {
		port = spec.Port
...
func (r *BomaRAGReconciler) valkeySecret(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) (*corev1.Secret, error) {
	spec := o.Spec.DoclingComponents.Valkey
	var password string
...
func (r *BomaRAGReconciler) reconcileNetworkPolicy(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string) error {
...
func (r *BomaRAGReconciler) setOwnerOrLabel(o *bomaragv1alpha1.BomaRAG, obj client.Object, targetNS string) error {
	if targetNS == o.Namespace {
...
func (r *BomaRAGReconciler) createOrUpdate(ctx context.Context, obj client.Object) error {
...
func (r *BomaRAGReconciler) deleteIfExists(ctx context.Context, obj client.Object) error {
...
// files from the ABISHAIMWANJA/bomarag GitHub repository at the given ref.
// It uses only Python stdlib so that python:3-alpine suffices.
const flowsDownloadScript = `
import urllib.request, json, os
ref = os.environ['FLOWS_REF']
api = 'https://api.github.com/repos/ABISHAIMWANJA/bomarag/contents/flows?ref=' + ref
req = urllib.request.Request(api, headers={
    'Accept': 'application/vnd.github.v3+json',
    'User-Agent': 'bomarag-operator/1.0',
})
...
func (r *BomaRAGReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&bomaragv1alpha1.BomaRAG{}).
...
const managedByLabel = "bomalogic.com/managed-by"

func targetNamespace(o *bomaragv1alpha1.BomaRAG) string {
...
func instanceResourceName(o *bomaragv1alpha1.BomaRAG, role string) string {
...
func instanceSAName(o *bomaragv1alpha1.BomaRAG, role string) string {
	if o.Spec.InstanceName != "" {
...
// resourceName generates a per-CR resource name with the bomarag- prefix.
// Max length with an 8-char instanceName: "bomarag-"(8) + 8 + "-valkey-headless"(16) = 32 chars.
func resourceName(crName, role string) string {
	switch role {
	case "ds":
		return "bomarag-" + crName + "-docling-serve"
	case "dw":
		return "bomarag-" + crName + "-docling-worker"
	default:
		return "bomarag-" + crName + "-" + role
	}
}
...
func getServiceAccountName(o *bomaragv1alpha1.BomaRAG, role string) string {
...
func shouldCreateServiceAccount(o *bomaragv1alpha1.BomaRAG, role string) bool {
	var createFlag *bool
	switch role {
	case "fe":
...
// If a custom name is specified in the spec, returns that; otherwise returns the default.
func getServiceName(o *bomaragv1alpha1.BomaRAG, role string) string {
	var customName string
	switch role {
	case "fe":
...
func shouldCreateService(o *bomaragv1alpha1.BomaRAG, role string) bool {
	var createFlag *bool
	switch role {
	case "fe":
...
// 4. Common resource labels (from BomaRAGSpec.CommonResourceLabels)
func mergeResourceLabels(o *bomaragv1alpha1.BomaRAG, baseLabels, componentLabels, resourceLabels map[string]string) map[string]string {
	merged := make(map[string]string)
...
// 3. Common resource annotations (from BomaRAGSpec.CommonResourceAnnotations)
func mergeResourceAnnotations(o *bomaragv1alpha1.BomaRAG, componentAnnotations, resourceAnnotations map[string]string) map[string]string {
	merged := make(map[string]string)
...
func mergePVCLabels(o *bomaragv1alpha1.BomaRAG, storage *bomaragv1alpha1.PersistenceSpec, baseLabels map[string]string) map[string]string {
...
func mergePVCAnnotations(o *bomaragv1alpha1.BomaRAG, storage *bomaragv1alpha1.PersistenceSpec) map[string]string {
...
func mergeServiceAccountLabels(o *bomaragv1alpha1.BomaRAG, spec bomaragv1alpha1.ComponentSpec, baseLabels map[string]string) map[string]string {
...
func mergeServiceAccountAnnotations(o *bomaragv1alpha1.BomaRAG, spec bomaragv1alpha1.ComponentSpec) map[string]string {
...
func mergeServiceLabels(o *bomaragv1alpha1.BomaRAG, spec bomaragv1alpha1.ComponentSpec, baseLabels map[string]string) map[string]string {
...
func mergeServiceAnnotations(o *bomaragv1alpha1.BomaRAG, spec bomaragv1alpha1.ComponentSpec) map[string]string {
	return mergeResourceAnnotations(o, spec.ServiceAnnotations, nil)
}

// mergeSecretLabels merges labels for Secret resources.
func mergeSecretLabels(o *bomaragv1alpha1.BomaRAG, spec bomaragv1alpha1.ComponentSpec, baseLabels map[string]string) map[string]string {
...
func mergeSecretAnnotations(o *bomaragv1alpha1.BomaRAG, spec bomaragv1alpha1.ComponentSpec) map[string]string {
...
func (r *BomaRAGReconciler) readSecretValue(ctx context.Context, namespace string, sel *corev1.SecretKeySelector) (string, error) {
	if sel == nil {
		return "", nil
	}
...
func (r *BomaRAGReconciler) readSecretRequiredProtection(ctx context.Context, namespace string, sel *corev1.SecretKeySelector) (string, error) {
	if sel == nil {
		return "", nil
	}
...
// collectProtectedSecrets gathers all user-provided secret references from the BomaRAG CR
func collectProtectedSecrets(o *bomaragv1alpha1.BomaRAG) []*corev1.SecretKeySelector {
...
func (r *BomaRAGReconciler) getOrGenerateSecret(ctx context.Context, o *bomaragv1alpha1.BomaRAG, targetNS string, userSecretRef *corev1.SecretKeySelector, envKeyName, envSecretName string, genFunc func() (string, error)) (string, error) {
