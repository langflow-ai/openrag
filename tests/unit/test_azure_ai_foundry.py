...
def test_build_azure_ai_foundry_url_base():
    ...
    assert url == "https://my-foundry.services.ai.azure.com/chat/completions?api-version=2024-05-01-preview"


def test_build_azure_ai_foundry_url_with_models_path():
    endpoint = "https://my-foundry.services.ai.azure.com/models"
    url = _build_azure_ai_foundry_url(endpoint, "/chat/completions")
    assert url == "https://my-foundry.services.ai.azure.com/models/chat/completions?api-version=2024-05-01-preview"
...
def test_build_azure_ai_foundry_url_preserves_custom_api_version():
    ...
    url = _build_azure_ai_foundry_url(endpoint, "/chat/completions")
    assert url == "https://my-foundry.services.ai.azure.com/models/chat/completions?api-version=2024-08-01-preview"
...
def test_build_azure_ai_foundry_url_embeddings():
    ...
    assert url == "https://my-foundry.services.ai.azure.com/embeddings?api-version=2024-05-01-preview"
