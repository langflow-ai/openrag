...
These documents are ingested automatically during the [application onboarding process](/install-uvx#application-onboarding).
...
When you [install OpenRAG](/install-options), you select at least one embedding model during the [application onboarding process](/install-uvx#application-onboarding).
...
To change this location, modify the **Documents Paths** variable in either the [**Basic/Advanced Setup** menu](/install-uvx#setup) or in your [OpenRAG `.env` file](/reference/configuration).
