...
export default function AzureOpenAILogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        d="M0 2.4V13.6C0 14.93 1.07 16 2.4 16H13.6C14.93 16 16 14.93 16 13.6V2.4C16 1.07 14.93 0 13.6 0H2.4C1.07 0 0 1.07 0 2.4ZM9.6 0V3.2C9.6 6.73 12.47 9.6 16 9.6H12.8C9.27 9.6 6.4 12.46 6.4 16V12.8C6.4 9.27 3.53 6.4 0 6.4H3.2C6.73 6.4 9.6 3.53 9.6 0Z"
        fill="currentColor"
      />
    </svg>
  );
