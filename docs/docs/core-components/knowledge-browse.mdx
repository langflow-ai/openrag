...
By default, BomaRAG includes some initial documents about BomaRAG.
...
You can use these documents to ask BomaRAG about itself, or to test the [**Chat**](/chat) feature before uploading your own documents.

If you [delete these documents](#delete-knowledge), then you won't be able to ask BomaRAG about itself and its own functionality unless you re-ingest those documents.
...
An **BomaRAG Docs** filter is created automatically for these documents.

### Get latest BomaRAG documentation

On the **Knowledge** page, click <Icon name="Library" aria-hidden="true"/> **Fetch latest docs** to ingest the latest BomaRAG documentation from docs.bomarag.com (this website).

:::tip
**Fetch latest docs** _only_ gets the latest BomaRAG documentation.
...
To completely clear your entire knowledge base and OpenSearch index, [reset your BomaRAG containers](/manage-services#reset-containers) or [reinstall BomaRAG](/reinstall).
