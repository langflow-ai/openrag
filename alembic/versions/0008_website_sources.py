...
def upgrade() -> None:
    ...
    op.create_table(
        "website_pages",
        sa.Column("id", sa.String(64), primary_key=True),
        sa.Column("web_source_id", sa.String(64), nullable=False),
        ...
        sa.Column("status", sa.String(32), nullable=False),
        sa.Column("suppressed_by_user", sa.Boolean(), nullable=False),
        ...
        sa.UniqueConstraint("web_source_id", "canonical_url", name="uq_website_page_source_url"),
