...
* Destroys all BomaRAG containers, volumes, and local images.
* Prunes any additional container objects.
* Deletes the contents of the `~/.bomarag` directory _except_ for BomaRAG's `.env` file and the `/documents` subdirectory.
