---
title: Contribute to BomaRAG
slug: /support/contribute
---

There are several ways you can interact with the BomaRAG community and contribute to the BomaRAG codebase.

## Star BomaRAG on GitHub

If you like BomaRAG, you can star the [BomaRAG GitHub repository](https://github.com/ABISHAIMWANJA/bomarag).
Stars help other users find BomaRAG more easily, and quickly understand that other users have found it useful.

Because BomaRAG is open-source, the more visible the repository is, the more likely the codebase is to attract contributors.

## Watch the GitHub repository

You can watch the [BomaRAG GitHub repository](https://github.com/ABISHAIMWANJA/bomarag) to get notified about new releases and other repository activity.
...
You can report bugs, submit feature requests, and get help with BomaRAG through the GitHub repository.

The repository is the best place to report bugs and request enhancements to ensure that they are tracked by BomaRAG maintainers.

### GitHub issues

The [Issues page in the BomaRAG repository](https://github.com/ABISHAIMWANJA/bomarag/issues) is actively updated with bugs and feature requests.
...
Feature planning for BomaRAG is tracked through the [Projects page in the BomaRAG repository](https://github.com/ABISHAIMWANJA/bomarag/projects).

### GitHub discussions

If you need help with your code or BomaRAG in general, you can visit the [BomaRAG GitHub Discussions page](https://github.com/ABISHAIMWANJA/bomarag/discussions).

The BomaRAG team doesn't provide individual support over email, and the team believes that public discussions help more users by virtue of their discoverability.

## Community guidelines and tips

Because the BomaRAG repository is public, the BomaRAG team asks that you follow these guidelines when submitting questions and issues:

* **Provide as many details as possible**: Simply stating that a feature doesn't work isn't helpful. The BomaRAG team needs details in order to recreate and find the issue.
...
* **Retrace your steps**: Explain what happened before the error, what you expected to happen instead of the error, and any recent changes you made, such as upgrading BomaRAG or a dependency.
* **Describe your environment**: Include your operating system, BomaRAG version, Python version, and any other environment-related details that could have contributed to the issue.
...
* **Be kind**: Although bugs can be frustrating with any software, remember that your messages are read by real people who want to help. While you don't have to be saccharine, there's no need to be rude to get support.
  ...
  * The BomaRAG repository is a public GitHub repository and, therefore, subject to the [GitHub Code of Conduct](https://docs.github.com/en/site-policy/github-terms/github-community-code-of-conduct).

## Contribute to the codebase

If you want to contribute code to BomaRAG, you can do so by submitting a pull request (PR) to the BomaRAG GitHub repository.

See [CONTRIBUTING.md](https://github.com/ABISHAIMWANJA/bomarag/blob/main/CONTRIBUTING.md) to set up your development environment and learn about the contribution process.

### Tips for successful submissions

* Explain the motivation for your submission in the PR description.
Clarify how the change benefits the BomaRAG codebase and its users.
...
If you use AI tools to generate significant portions of the code in your PR, the BomaRAG team asks that you do the following:
...
* Avoid using AI tools to generate large volumes of code if you don't have personal knowledge of that language and the functionality being implemented. Instead, consider submitting a feature request to the [Issues page in the BomaRAG repository](https://github.com/ABISHAIMWANJA/bomarag/issues).
...
The BomaRAG documentation is built using [Docusaurus](https://docusaurus.io/) and written in [Markdown](https://docusaurus.io/docs/markdown-features).
For style guidance, see the [Google Developer Documentation Style Guide](https://developers.google.com/style).

1. Install [Node.js](https://nodejs.org/en/download/package-manager).

2. Fork the [BomaRAG GitHub repository](https://github.com/ABISHAIMWANJA/bomarag).

3. Add the new remote to your local repository on your local machine:

    ```bash
    git remote add FORK_NAME https://github.com/GIT_USERNAME/bomarag.git
    ```
...
6. To edit and create content, work with the `.mdx` files in the `bomarag/docs/docs` directory.

    Create new files in `.mdx` format.

    Navigation is defined in `bomarag/docs/sidebars.js`.
...
8. Create a pull request against the `main` branch of the BomaRAG repository with a clear title and description of your changes:

   * Provide a clear title in the format of `Docs: <summary of change>`. For example, `Docs: fix broken link on contributing page`. Pull request titles appear in BomaRAG's release notes, so they should explain what the PR does as explicitly as possible.
...
10. Keep an eye on your pull request in case an BomaRAG maintainer requests changes or asks questions.

   BomaRAG technical writers can directly edit documentation PRs to enforce style guidelines and fix errors.