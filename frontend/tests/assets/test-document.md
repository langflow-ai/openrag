...
- Intelligent Document Ingestion: Support for multiple file formats including PDF, TXT, and Markdown.
- Vector Storage: Optimized retrieval using state-of-the-art vector similarity search.
