...
| `LANGFLOW_PORT` | `7860` | Host port for the Langflow service. Change this if port 7860 is already in use on your system. If you change this, also update `LANGFLOW_PUBLIC_URL` to match the new port. |
