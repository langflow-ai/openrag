...
The **Knowledge** page lists the documents OpenRAG has ingested into your [OpenSearch knowledge base](/knowledge), specifically in an [OpenSearch index](/knowledge#index) named `documents`.
